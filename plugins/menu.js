...
let handler  = async (m, { conn, usedPrefix: _p }) => {
  try {
    ...
    let before = conn.menu.before || `${conn.getName(conn.user.jid)} • Bot\n\nHalo user ici bot, %name!\n Total: *%exp XP*\n\n*Limit Mu:* %limit\n*Tanggal:* *%week, %date*\n Waktu: *%time*\n_Uptime: %uptime_\n*Banyak User Bot Ichi Maslent:* %totalreg\n\nYuoutube:\nhttps://youtube.com/channel/UCAn_1yox-jIUFhUVYTxI_JA\n\n 🤗JOIN GRUP ICHI🤗\nhttps://chat.whatsapp.com/DkrIVmJd4YJJgJBnvV47X7\n`
